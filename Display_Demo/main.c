...
void OTG_FS_IRQHandler(void){
  ...
  {
    /*
    *( (volatile unsigned long *) OTG_FS_DOEPCTL0) |= 1 << 27; 
    *( (volatile unsigned long *) OTG_FS_DAINTMSK) |= 1 << 0; 
    *( (volatile unsigned long *) OTG_FS_DAINTMSK) |= 1 << 16; 
    *( (volatile unsigned long *) OTG_FS_DOEPMSK) |= 1 << 3; 
    *( (volatile unsigned long *) OTG_FS_DOEPMSK) |= 1 << 0; 
    
    *( (volatile unsigned long *) OTG_FS_DIEPMSK) |= 1 << 0; 
    *( (volatile unsigned long *) OTG_FS_DIEPMSK) |= 1 << 3; 
    
   *( (volatile unsigned long *) OTG_FS_GRXFSIZ) |= 0x10; 
      
   *( (volatile unsigned long *) OTG_FS_HNPTXFSIZ) |= 0x10; 
